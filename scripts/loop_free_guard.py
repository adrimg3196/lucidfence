...
def main(argv=None) -> int:
    ...
    # --strict is accepted for explicit fail-closed semantics. The guard is ALWAYS
    # fail-closed (detection == prevention, both default-deny): any non-free model
    # in the catalog returns exit 1 regardless of --strict. The flag exists so CI
    # invocations can name the intent literally (see AC #2 of t_c902d16a).
    ap.add_argument("--strict", action="store_true", help="fail-closed (default behavior; named explicitly)")
