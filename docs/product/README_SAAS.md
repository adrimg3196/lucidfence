...
LucidFence es **gratis para siempre**: sin planes de pago, sin límites artificiales, sin pasarela. El proyecto se sostiene con donaciones (`.github/FUNDING.yml`). Detalle en **[`docs/gtm/revenue-model.md`](../gtm/revenue-model.md)**.
