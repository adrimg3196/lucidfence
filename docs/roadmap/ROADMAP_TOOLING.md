...
`python3 -m lucidfence.core.roadmap_tooling`, se expone en `GET /api/roadmap` (cuando el
...
```bash
cd ~/geofence-uem
python3 -m lucidfence.core.roadmap_tooling --validate     # valida el schema (debe decir "valido")
python3 -m lucidfence.core.roadmap_tooling                # muestra el plan + barra de progreso
python3 -m lucidfence.core.roadmap_tooling --phase Q3-2026
