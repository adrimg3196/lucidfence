...
`python3 lucidfence/core/roadmap_tooling.py`, se expone en `GET /api/roadmap` (cuando el
...
| 2 | **Motor** | `lucidfence/core/roadmap_tooling.py`: load/save/validate/format/update; el schema es la ley | `lucidfence/core/roadmap_tooling.py` |
| 3 | **CLI** | `python3 lucidfence/core/roadmap_tooling.py [--validate/--status/--phase/--mark/--export]` | `lucidfence/core/roadmap_tooling.py` |
...
```bash
cd ~/geofence-uem
python3 lucidfence/core/roadmap_tooling.py --validate     # valida el schema (debe decir "valido")
python3 lucidfence/core/roadmap_tooling.py                # muestra el plan + barra de progreso
python3 lucidfence/core/roadmap_tooling.py --phase Q3-2026
python3 lucidfence/core/roadmap_tooling.py --mark F1.1 status done   # marca y persiste
