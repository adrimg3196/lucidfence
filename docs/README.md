...
| Documento | Contenido |
| --- | --- |
| [`README.en.md`](README.en.md) | Project overview in English (the counterpart of the root `README.md`; badges, moat, install, smoke test). For a full English walkthrough see `manual/USER_GUIDE.md` |
