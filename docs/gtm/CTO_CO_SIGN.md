...
| `2026-08-21-declarative-enforcement.md` | declarative | 0 BLOCK / 1 INFO | **CO-FIRMADA** (corregida por arbitraje `t_2c00a8f2` decisión A: DSC build-only + read-back Graph, NO end-to-end) + owner gate |
