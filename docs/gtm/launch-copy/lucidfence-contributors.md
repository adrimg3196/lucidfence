...
LucidFence es multi-MDM porque la comunidad lo alimenta. Si manejas un MDM que aún no tiene adapter, o tienes casos de riesgo que el engine debería entender, este es tu lugar.

## Cómo contribuir

- **Adapters (MDMAdapter):** ¿Intune, Jamf, Mosyle, Kandji? Abre un adapter. Las primeras son bienvenidas con la etiqueta `good first adapter`.
