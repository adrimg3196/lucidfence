...
- **`docs/internal/exec/traction.jsonl`** — la serie real, append-only. Es tu
  fuente; nada de números de memoria.
- **`documentation-writer`** — el informe se escribe para quien decide, no para
  quien programa.
